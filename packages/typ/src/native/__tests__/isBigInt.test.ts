...
describe("isBigInt", () => {
    ...
    test("object of BigInt", () => {
        ...
        expect(isBigInt(BigInt(-6))).toBeTruthy();
        expect(isBigInt(BigInt(Number.MAX_SAFE_INTEGER))).toBeTruthy();
        expect(isBigInt(BigInt(Number.MIN_SAFE_INTEGER))).toBeTruthy();
        expect(isBigInt(BigInt(Number.MAX_SAFE_INTEGER + 1))).toBeTruthy();
        expect(isBigInt(BigInt(Number.MIN_SAFE_INTEGER - 1))).toBeTruthy();
    });
