 ...
 * @example
 *
 * words("GarlicGo likes to eat garlic")
 * // => ["GarlicGo", "likes", "to", "eat", "garlic"]
 *
 * words("GarlicGo likes to eat garlic", /[a-z]+/gmu)
 * // => ["arlic", "o", "likes", "to", "eat", "garlic"]
 *
 * words("GarlicGo likes to eat garlic", "acgilor")
 * // => ["GarlicGo", "li", "o", "a", "garlic"]
 *
 * words("GarlicGo likes to eat garlic", ["GarlicGo", "garlic"])
 * // => ["GarlicGo", "garlic"]
 */
export function words(value: string, pattern?: RegExp): string[];
export function words(value: string, lexicon: string[]): string[];
export function words(value: string, characters: string): string[];
export function words(value: string, plc: RegExp | string[] | string = /[0-9a-zA-Z]+/gmu): string[] {
